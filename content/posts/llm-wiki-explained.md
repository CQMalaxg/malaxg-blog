...
draft = false
title = 'LLM Wiki 详解：从知识检索到知识编译'
tags = ['LLM', 'Knowledge Base', 'RAG', 'LLM Wiki', 'Karpathy']
categories = ['学习资料']
+++
...
![编译知识 vs 检索知识](/llm-wiki-blog-img/01-compile-vs-retrieve.svg)
...
![LLM Wiki 三层架构](/llm-wiki-blog-img/02-three-layers.svg)
...
![三大操作与复利飞轮](/llm-wiki-blog-img/03-three-operations.svg)
...
![输入 / 处理 / 输出 全景](/llm-wiki-blog-img/04-io-overview.svg)
...
![增量编译：两份账本 join 判定](/llm-wiki-blog-img/05-incremental-join.svg)
...
![两遍推送：破解页面互链的鸡生蛋](/llm-wiki-blog-img/06-two-pass-push.svg)
